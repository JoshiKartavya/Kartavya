...
const About = () => {
  return (
    <div className='h-[130vh] w-full flex flex-col justify-center items-center bg-[--secondary] text-[--primary] py-8 px-12'>
      <div className="title h-[50vh] w-full flex flex-row">
      ...
      <div className="me h-[80vh] w-full flex flex-row">
        <div className="image h-full w-2/5 flex flex-col justify-center">
          <Image className='rounded-lg' src="/kartavya.png" alt='kartavya' width={400} height={350} />
        </div>
