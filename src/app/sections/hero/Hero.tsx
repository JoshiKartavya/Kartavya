    ...
    <>
      <div className='h-screen w-full flex flex-col justify-start items-center bg-[--primary] text-[--secondary]'>
        ...
        <div className="hero w-full h-[40vh] sm:h-[50vh] md:h-[70vh] lg:h-[80vh] pt-[10vh] lg:pt-20 xl:pt-4">
          <h1 className='text-[6rem] sm:text-[6rem] md:text-[9rem] lg:text-[12rem] xl:text-[20rem] text-center font-bebas capitalize font-black'>
            Kartavya Joshi
          </h1>
          <div>
            <div className="content flex flex-col items-center sm:flex-row justify-between px-8 mt-12 lg:mt-18 xl:mt-8 gap-6">
              ...
              <div className="left w-full sm:w-auto flex flex-col items-center sm:items-start text-center sm:text-left gap-4">
                <p className='text-sm md:text-xl lg:text-2xl capitalize font-noto font-medium'>
                  I help brands and freelancers to grow their dreams and stand them out than other companies
                </p>

                {/* Add Image between paragraph and button for smaller devices */}
                <div className="sm:hidden">
                  <Image className='rounded-lg' src="/me.jpg" alt='kartavya' width={200} height={200} />
                </div>
              ...
              <div className="right hidden sm:block">
                <div className="img hidden sm:block absolute z-10 left-[54%] top-[50%] md:top-[45%] lg:top-[50%] xl:top-[35%]">
                  <Image className='rounded-lg' src="/me.jpg" alt='kartavya' width={350} height={350} />
                </div>
