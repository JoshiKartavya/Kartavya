...
const Services = () => {
  return (
    <div className='h-screen xl:h-screen w-full flex flex-col justify-start items-center bg-[--secondary] py-16 px-8 gap-16'>
      <div className='title'>
        <h1 className='text-6xl xl:text-9xl font-bebas font-semibold text-center'>What do i provide ?</h1>
      </div>
